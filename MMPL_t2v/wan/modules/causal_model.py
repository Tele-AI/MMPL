        ...
        if self.block_mask is None:
            if clean_x is not None:
                if self.independent_first_frame:
                    ...
                    clean_steps = [0, 0, 1, 1, 2, 2, 2, 2, 2, 2, 1, 1, 1, 3, 3, 3, 3, 3, 3, 1, 1] # important for anchor-forcing
                    
                    # clean_steps = [0, 0, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 1, 3, 3, 3, 3, 3, 3, 1, 1] # important for ablation without near - finished
                    # clean_steps = [0, 0, 1, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 1, 1] # important for ablation without mid
