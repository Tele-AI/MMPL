...
for i, batch_data in tqdm(enumerate(dataloader), disable=(local_rank != 0)):
    ...
    def generate_video_chunk(pipeline, sampled_noise, prompts, chunk_idx, args, wait_file=None):
        ...
        # if wait_file is None: pipeline.save = 'latents_chunk4.pt'
        # elif wait_file == 'latents_chunk1.pt': pipeline.save = 'latents_chunk5.pt'
        # elif wait_file == 'latents_chunk2.pt': pipeline.save = 'latents_chunk6.pt'
        # elif wait_file == 'latents_chunk3.pt': pipeline.save = 'latents_chunk7.pt'

        # elif wait_file == 'latents_chunk4.pt': pipeline.save = 'latents_chunk8.pt'
        # elif wait_file == 'latents_chunk5.pt': pipeline.save = 'latents_chunk9.pt'
        # elif wait_file == 'latents_chunk6.pt': pipeline.save = 'latents_chunk10.pt'
        # elif wait_file == 'latents_chunk7.pt': pipeline.save = 'latents_chunk11.pt'
        if wait_file is None:
            pipeline.save = 'latents_chunk4.pt'
        else:
            current_num = int(re.search(r'latents_chunk(\d+)\.pt', wait_file).group(1))
            pipeline.save = f'latents_chunk{current_num + 4}.pt'
